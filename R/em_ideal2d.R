...
#' @param a Fixed values for the difficulty parameters
#' @param b1 Fixed values for the first discrimination parameter
#' @param b2 Fixed values for the second discrimination parameter
...
#'
#' @examples
gpu_em_ideal2d_np <- function(rcdata,steps,burnin=0,thin=1,x1=NULL,x2=NULL,
