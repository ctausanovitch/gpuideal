#' Run the EM ideal estimator on the GPU with fixed item parameters using Nokken Poole
#'
...
#' @param a Fixed values for the difficulty parameter
#' @param b Fixed values for the discrimination parameter
...
#'
#' @examples
gpu_em_ideal_np <- function(rcdata,steps,burnin=0,thin=1,x=NULL,a=NULL,b=NULL,abprior=matrix(c(20,0,0,20),2,2),xprior=1,
	             blocks=0, threads=0) {
